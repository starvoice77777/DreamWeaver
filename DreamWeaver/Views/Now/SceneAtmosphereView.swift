    ...
    var body: some View {
        TimelineView(.animation(minimumInterval: reduceMotion ? 1.0 / 8.0 : 1.0 / 30.0, paused: reduceMotion && !isPlaying)) { timeline in
            ...
            Canvas { context, size in
                ...
                case .himalaya: drawFireflies(context: &context, size: size, t: t)
                ...
                case .longRoad: drawWarmLamp(context: &context, size: size, t: t)
                case .snowStudy: drawSnow(context: &context, size: size, t: t)
                case .wheatWave: drawWheat(context: &context, size: size, t: t)
                case .flight: drawCloudBreath(context: &context, size: size, t: t)
                case .summerNight: drawInsects(context: &context, size: size, t: t)
